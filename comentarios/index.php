...
<body>
    <div class="container-fluid">
        ...
        <main class="row">
            <div class="col-12">
                <section class="row align-items-center my-4">
                    <div class="col-md-8">
